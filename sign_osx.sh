...
codesign -f -s "$APP_KEY" --entitlements platforms/osx/parent.plist "$APP_BIN_PATH"
codesign -f -s "$APP_KEY" --entitlements platforms/osx/parent.plist "$APP_PATH"
codesign --deep --force --verbose --sign "$APP_KEY" --entitlements platforms/osx/parent.plist "$APP_BIN_PATH"
